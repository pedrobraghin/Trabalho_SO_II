...
public class LRU extends Algorithm {
    ...
    public LRU(String pagesPath, int numFrames, int uniquePages, int numPagReq) {
    ...
    */
    ...
    /**
     * Método para desempilhar a pilha auxliar de frames ocupados
     * @return
     */
    ...
    */
    ...
    /**
     * Método para a página que um frame guarda
     * @param nFrame
     * @param numPag
     * @param pagina
     */
    ...
    /**
     * Método para atualizar a pilha de frames ocupados, o frame recem acesado vai para o topo da fila
     * @param x
     */
